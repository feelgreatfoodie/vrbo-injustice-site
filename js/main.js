...
// Track social shares (add to your main.js)
document.querySelectorAll(".btn-social").forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    const platform = this.classList.contains("btn-x")
      ? "x"
      : this.classList.contains("btn-facebook")
      ? "facebook"
      : "reddit";
    ...
    if (typeof gtag !== "undefined") {
      gtag("event", "share", {
        method: platform,
        content_type: "story",
        content_id: "vrbo-host-story",
      });
    }
  });
});

// Track evidence modal views
